        ...
        Optional<Event> result = eventRepository
            ...
            .map(existingEvent -> {
                ...
                if (event.getEventCity() != null) {
                    existingEvent.setEventCity(event.getEventCity());
                }
                ...
                if (event.getEventEmail() != null) {
                    existingEvent.setEventEmail(event.getEventEmail());
                }
                if (event.getEventImage() != null) {
                    existingEvent.setEventImage(event.getEventImage());
                }
                if (event.getEventImageContentType() != null) {
                    existingEvent.setEventImageContentType(event.getEventImageContentType());
                }
