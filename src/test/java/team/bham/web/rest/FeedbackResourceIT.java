...
class FeedbackResourceIT {
    ...
    public static Feedback createEntity(EntityManager em) {
        Feedback feedback = new Feedback().feedbackText(DEFAULT_FEEDBACK_TEXT).time(DEFAULT_TIME);
        return feedback;
    }
    ...
    public static Feedback createUpdatedEntity(EntityManager em) {
        Feedback feedback = new Feedback().feedbackText(UPDATED_FEEDBACK_TEXT).time(UPDATED_TIME);
        return feedback;
    }
    ...
    void createFeedback() throws Exception {
        ...
        assertThat(testFeedback.getFeedbackText()).isEqualTo(DEFAULT_FEEDBACK_TEXT);
    ...
    void putExistingFeedback() throws Exception {
        ...
        updatedFeedback.feedbackText(UPDATED_FEEDBACK_TEXT).time(UPDATED_TIME);
        ...
        Feedback testFeedback = feedbackList.get(feedbackList.size() - 1);
        assertThat(testFeedback.getFeedbackText()).isEqualTo(UPDATED_FEEDBACK_TEXT);
    ...
    void partialUpdateFeedbackWithPatch() throws Exception {
        ...
        partialUpdatedFeedback.time(UPDATED_TIME);
    ...
    void fullUpdateFeedbackWithPatch() throws Exception {
        ...
        partialUpdatedFeedback.feedbackText(UPDATED_FEEDBACK_TEXT).time(UPDATED_TIME);
